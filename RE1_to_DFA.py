...
#
# RE 2 : (and|or|\|\||&&|not|!)
# Function : This programming regex matches logical operators such as and, or, ||, &&, not, and !.
# Example code_block = '''
#  if (condition1 && condition2 || !condition3) {
#   // do something
# } else if (condition1 or condition2 == 2) {
#   // do something else
# }
#  '''
import re
...
def get_accepted_tokens(tokens, transition_list):
    matched_symbols = []
    for token in tokens:
        for symbol in token:
            for transition_symbol in transition_list:
...
print(pregex)
syntax_tree = postfix_to_syntax_tree(pregex)
print("Syntax Tree : ")
...
tokens = re.findall(r'\b\w+\b|[+\-*/%=(),<>]+', code_block)
print("Tokenized Code Block : ")
print(tokens)

transition_list = transitions_to_list(Dfa.transitions)
print("Transistion List : ")
